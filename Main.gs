 ...
 * 
 * UPDATED: Fixed menu to use new Room Status Dashboard instead of old availability checker
 */

/**
 * Create custom menu when spreadsheet opens
 * UPDATED: Fixed menu items to use new Room Status Dashboard
 */
function onOpen() {
  ...
  ui.createMenu('🏠 White House Manager')
    ...
    .addSubMenu(ui.createMenu('🏨 Guest Management')
      .addItem('📊 Room Status Dashboard', 'showBookingManagerPanel')  // ← UPDATED: Now shows new dashboard
...
/**
 * UPDATED: New Room Status Dashboard (replaces old availability checker)
 */
...
/**
 * UPDATED: New function to get current room status for the dashboard
 */
...
/**
 * Individual Booking Panel wrapper functions (these still work)
 */
